...
class DatabaseMetrics( Database ):
    ...
    def insert_metrics_data(self, dataset_name, model_name, model_data_domain, model_window_length,
        ...
        try:
            self.cursor.execute(sql_file, (dataset_name, model_name, model_data_domain, model_window_length,
                                                accuracy, precision, sensitivity, specificity,
                                                true_positive_rate, false_positive_rate, f1_score,
                                                true_positives, true_negatives, false_positives, false_negatives, total_samples,))
            self.db.commit()
    ...
    def metrics_by_model_domain_window(self, dataset_name, model_name, domain_name, window_length):
        ...
        try:
            self.cursor.execute(sql_file, (dataset_name, model_name, domain_name, window_length,))
