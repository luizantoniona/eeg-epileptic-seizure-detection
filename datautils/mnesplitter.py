...
def segmented_time_data_splitter(summaries: list[sm.SummaryModel]):
    ...
    X_train_segmented_time_data = np.array([summary.signal.get_time_segmented_data() for summary in X_train])
    X_val_segmented_time_data = np.array([summary.signal.get_time_segmented_data() for summary in X_val])
...
def segmented_freq_data_splitter(summaries: list[sm.SummaryModel]):
    ...
    X_train_segmented_freq_data = np.array([summary.signal.get_freq_segmented_data()[0] for summary in X_train])
    X_val_segmented_freq_data = np.array([summary.signal.get_freq_segmented_data()[0] for summary in X_val])
...
def segmented_time_freq_data_splitter(summaries: list[sm.SummaryModel]):
    ...
    X_train_segmented_time_freq_data = [summary.signal.get_time_freq_segmented_data() for summary in X_train]
    X_val_segmented_time_freq_data = [summary.signal.get_time_freq_segmented_data() for summary in X_val]
