...
def summaries_data_splitter(summaries: list[sm.SummaryModel], split_size=0.2) -> tuple[list[sm.SummaryModel], list[sm.SummaryModel], np.array, np.array]:
    """
...
def segmented_summaries_data_splitter(summaries: list[sm.SummaryModel], split_size=0.2) -> tuple[list[sm.SummaryModel], list[sm.SummaryModel], np.array, np.array]:
    """
