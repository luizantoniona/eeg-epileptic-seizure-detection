...
class Metric:
   """
   """
   def __init__(self, test, predictions, model_name, model_data_domain, model_window_length):
   ...
   def metrics_to_database(self):
      ...
      database.insert_metrics_data(self.model_name, self.model_data_domain, self.model_window_length,
